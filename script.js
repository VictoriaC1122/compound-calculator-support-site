const copy = {
  home: {
    zh: {
      title: "複利計算機｜隱私與使用說明",
      description: "複利計算機的官方網站，提供隱私權政策、版權聲明與產品使用說明。",
      brandName: "複利計算機",
      navPrivacy: "隱私權政策",
      navCopyright: "版權聲明",
      heroEyebrow: "Compound Calculator",
      heroTitle: "把重要的使用說明，整理成更清楚的一頁",
      heroCopy: "這裡整理了複利計算機的隱私權政策、版權資訊與使用說明。你可以在這裡快速了解 App 如何處理資料、哪些內容受版權保護，以及使用時需要知道的基本資訊。",
      highlightOne: "隱私權政策",
      highlightTwo: "版權聲明",
      highlightThree: "使用說明",
      ctaPrivacy: "查看隱私權政策",
      ctaCopyright: "查看版權聲明",
      featureEyebrow: "產品介紹",
      featureTitle: "一個幫你看懂資產變化的財務規劃工具",
      featureCopy: "複利計算機提供投資複利、財務自由、退休規劃與貸款試算等工具，讓你可以用更直觀的方式理解長期資產變化、報酬假設與貸款壓力。",
      metricOneLabel: "主要功能",
    ...
    en: {
      title: "Compound Calculator | Privacy & Usage",
      description: "Official website for Compound Calculator, including the privacy policy, copyright notice, and product guidance.",
      brandName: "Compound Calculator",
      navPrivacy: "Privacy Policy",
      navCopyright: "Copyright Notice",
      heroEyebrow: "Compound Calculator",
      heroTitle: "One clear place for the information you may want before using the app",
      heroCopy: "This site brings together the privacy policy, copyright notice, and product guidance for Compound Calculator. It is designed to help you quickly understand how the app handles data, what content is protected, and what you may want to know before using it.",
      highlightOne: "Privacy Policy",
      highlightTwo: "Copyright Notice",
      highlightThree: "User Guide",
      ctaPrivacy: "View Privacy Policy",
      ctaCopyright: "View Copyright Notice",
      featureEyebrow: "Product Overview",
      featureTitle: "A planning tool that helps you understand how assets may evolve over time",
      featureCopy: "Compound Calculator includes tools for investing, FIRE planning, retirement planning, and loan analysis, so you can understand long-term asset changes, return assumptions, and debt pressure more clearly.",
  ...
  privacy: {
    ...
    en: {
      ...
      goCopyright: "Go to Copyright Notice",
  ...
  copyright: {
    zh: {
      ...
      backHome: "回首頁",
      goPrivacy: "前往隱私權政策",
      section1Title: "1. 著作權歸屬",
      section1Copy: "複利計算機 App、本網站、介面設計、文案、圖像、圖表呈現、程式碼結構與相關內容，除另有標示外，其著作權與其他智慧財產權均屬開發者所有。",
      section2Title: "2. 使用限制",
      section2Intro: "未經明確授權，不得對以下內容進行重製、散布、公開傳輸、改作、再授權或商業使用：",
      section2Item1: "App 內畫面設計與品牌視覺",
      section2Item2: "本網站內容與版面設計",
      section2Item3: "試算結果呈現方式、報告樣式與說明文案",
      section2Item4: "應用程式圖示與品牌識別元素",
      section3Title: "3. 第三方權利",
      section3Copy: "本 App 可能使用 Apple 提供的系統框架、介面元件或訂閱服務。相關名稱、商標與服務權利，分別屬於各自權利人所有。",
      section4Title: "4. 內容性質聲明",
      section4Copy: "複利計算機提供的是試算、整理與比較工具，不保證投資報酬、貸款核准結果、保險給付或退休規劃成果。網站與 App 內容屬於一般資訊與工具說明，不構成投資、保險、貸款、會計或法律意見。",
      section5Title: "5. 回報與聯絡",
      section5Copy: "如果你認為本網站或 App 內容涉及權利侵害，或希望進一步了解授權使用方式，可透過 GitHub 聯絡開發者：<a href=\"https://github.com/VictoriaC1122\" target=\"_blank\" rel=\"noreferrer\">VictoriaC1122</a>",
      footerCopy: "© 2026 複利計算機. All rights reserved."
    },
    en: {
      title: "Compound Calculator | Copyright Notice",
      description: "Learn about copyright ownership and permitted use of Compound Calculator content.",
      brandName: "Compound Calculator",
      navPrivacy: "Privacy Policy",
      navCopyright: "Copyright Notice",
      heroEyebrow: "Copyright",
      ...
      section2Title: "2. Usage Restrictions",
      section2Intro: "Without explicit permission, the following may not be reproduced, distributed, publicly transmitted, adapted, relicensed, or used commercially:",
      ...
      section3Title: "3. Third-Party Rights",
      ...
      section4Title: "4. Nature of the Content",
      section4Copy: "Compound Calculator provides tools for calculation, organization, and comparison. It does not guarantee investment returns, loan approval outcomes, insurance payouts, or retirement planning results. The app and website content is general informational and product guidance material, not investment, insurance, lending, accounting, or legal advice.",
      section5Title: "5. Contact and Reporting",
      section5Copy: "If you believe any website or app content infringes your rights, or you would like to discuss permission or licensing, you may contact the developer through GitHub: <a href=\"https://github.com/VictoriaC1122\" target=\"_blank\" rel=\"noreferrer\">VictoriaC1122</a>",
      footerCopy: "© 2026 Compound Calculator. All rights reserved."
    }
  }
};
...
function applyLanguage(lang) {
  ...
  document.querySelectorAll("[data-i18n]").forEach((node) => {
    ...
    if (node.tagName === "P" && pageCopy[key].includes("<a ")) {
