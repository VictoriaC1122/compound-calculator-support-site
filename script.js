const copy = {
  home: {
    zh: {
      ...
      heroTitle: "在使用複利計算機前，先快速看懂重要資訊",
      heroCopy: "這裡整理了複利計算機和你最相關的內容，包含資料如何處理、內容如何使用，以及使用服務前可以先了解的基本條款。不需要看很久，你可以直接從下面三個入口找到需要的資訊。",
      highlightOne: "隱私權政策",
      highlightTwo: "版權聲明",
      highlightThree: "使用條款",
      ctaPrivacy: "查看隱私權政策",
    ...
    en: {
      ...
      description: "Official website for Compound Calculator, including the privacy policy, copyright notice, terms of use, and product guidance.",
      brandName: "Compound Calculator",
      navPrivacy: "Privacy Policy",
      navCopyright: "Copyright Notice",
      navTerms: "Terms of Use",
      heroEyebrow: "Compound Calculator",
      heroTitle: "A clear place to review the essentials before using Compound Calculator",
      heroCopy: "This page brings together the information most relevant to you, including how data is handled, how content may be used, and the basic terms you may want to understand before using the service. You can start from the three links below and go straight to what you need.",
